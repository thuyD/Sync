...
var AudioGround = function () {
  ...
  _createClass(AudioGround, [{
    ...
    key: 'play',
    value: function play() {
      document.getElementById('play').addEventListener('click', this.playMusic.bind(this));
    }
  }, {
    key: 'pause',
    value: function pause() {
      document.getElementById('pause').addEventListener('click', this.pauseMusic.bind(this));
    }
  }, {
    key: 'playMusic',
    ...
    value: function startMonitoring() {
      document.getElementById('start-monitoring').addEventListener('click', this.handleMonitoring.bind(this));
    }
  }, {
    key: 'stopMonitoring',
    value: function stopMonitoring() {
      document.getElementById('stop-monitoring').addEventListener('click', this.handleStopMonitoring.bind(this));
    }
  }]);
